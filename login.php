      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 ml-auto mr-auto">
          <div class="card card-login">
            <form class="form" method="post" action="proses.php?login=login">
              <div class="card-header card-header-primary text-center">
                  <br>
                  <h4 class="card-title">Login Pelanggan</h4>
                  <br>
              </div>
              <div class="card-body">
              ...
              <div class="footer text-center">
                ...
                <a href="loginadmin.php"><p class="description text-center">Login Sebagai Admin</p></a>
              </div>
            </form>
          </div>
        </div>
