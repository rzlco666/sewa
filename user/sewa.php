                ...
                <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="fortglsewa" placeholder="Tanggal Sewa" name="tgl_sewa" min="2013-12-25">
                        </div>
                        </div>
                        </div>
                        <div class="row">
